...
MARITAL_STATUS = (
('Monogamous Marriage', 'Monogamous Marriage'), ('Polygamous Marriage', 'Polygamous Marriage'), ('Single', 'Single'),
...
CPT_GOALS_CHOICES = (
    ...
    ('CPTG1sa',
     'All household members have identified a social support network for psychosocial and emotional support.'),
...
CPT_GAPS_SAFE_CHOICES = (
    ...
    ('PG 1s',
     'Caregiver NOT provided with information on legal documents (e.g. ID, birth certificate, title deed, death certificate)'),
    ...
    ('SG 2s',
     'Caregiver NOT trained to engage & communicate with adolescent on sensitive topics sexual reproductive health services and rights'),
...
CPT_SERVICES_SAFE_CHOICES = (
    ...
    ('CPTS3p',
     'Psychosocial support to children living with HIV, caregiver support, children clubs, support groups for SGBV survivors'),
    ...
    ('CPTP13p',
     'Provide caregiver  with information on importance of legal documents e.g. ID, title deed, death certificate'),
...
WB_STA_13_1_CHOICES = (
    ...
    ('Protective food',
     'Protective food (pineapples, mangos, pawpaw, oranges, tomatoes, avaocado, guavas, bananas, vegetables)')
...
FAMILY_MEMBERS_CHOICES = (('Mother', 'Mother (1)'), ('Father', 'Father (2)'), ('Aunt', 'Aunt (3)'),
                          ('Uncle', 'Uncle (4)'), ('Grandmother', 'Grandmother (5)'),
                          ('Grandfather', 'Grandfather (6)'), ('Other sibling', 'Older sibling (7)'),
                          ('Other relative', 'Other relative(specify) (8)'), ('OTHER', 'Other (specify)'))
...
SUPPORT_CHOICES = (
('Legal', 'Legal Assistance'), ('Psychosocial', 'Psychosocial support'), ('Medical', 'Medical services'),
('Other', 'Other'))
...
class HIV_MANAGEMENT_VISITATION_FORM(forms.Form):
    ...
    HIV_MGMT_2_H_5 = forms.ChoiceField(
        choices=(
        ('HIV_POSTIVE', 'HIV_Positive'), ('HIV_NEGATIVE', 'HIV_NEGATIVE'), ('HIV_UNKOWN', 'HIV_UNKOWN/UNDISCLOSED')),
        widget=forms.RadioSelect(
            renderer=RadioCustomRenderer,
            attrs={
                # 'data-parsley-required': 'true',
